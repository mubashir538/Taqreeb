...
class _CategoryView_ParlourState extends State<CategoryView_Parlour> {
  ...
  void initState() {
    ...
    print("📌 User opened CategoryView_Parlour at: $entryTime");
  }
  ...
  void dispose() {
    if (entryTime != null) {
      ...
      print(
          "🕒 Logging category view duration for Parlour: $timeSpent seconds");
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Center(
                                    ...
                                    onPressed: () async {
                                      print(
                                          "🛒 User clicked 'Book Parlour' for listing ID: $listingId");
