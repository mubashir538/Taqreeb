...
class CategoryViewVenue extends StatefulWidget {
  const CategoryViewVenue({super.key});

  @override
  State<CategoryViewVenue> createState() => CategoryViewVenueState();
}

class CategoryViewVenueState extends State<CategoryViewVenue> {
  // State variables
