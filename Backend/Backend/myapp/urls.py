...
from .Chatbot.chat_Bot_views_test import chatbot_api, reset_chat_api
...
urlpatterns = [
    ...
    path('reset-chat', reset_chat_api, name='reset_chat_api'),
    # path('chatbot/', chatbot.chatbot_api, name='chatbot_api'),
    # path('chatbot/saveEvent', chatbot.chatbot_api, name='saveEvent'),
